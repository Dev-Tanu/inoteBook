          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form className="my-3">
                ...
                <button
                  type="submit"className="btn btn-primary"onClick={handleClick}> Submit</button>
              </form>
            </div>
            <div className="modal-footer">
              <button
                type="button"ref={refclose}className="btn btn-secondary"data-bs-dismiss="modal">Close</button>
